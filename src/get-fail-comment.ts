...
const formatError = (error: any) => `### ${error.message}
...
export const GetFailComment = (branch: any, errors: any) => `## :rotating_light: The automated release from the \`${
  branch.name
...
${errors.map((error: any) => formatError(error)).join('\n\n---\n\n')}
